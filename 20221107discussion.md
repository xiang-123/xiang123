        ...
        - 今の困っているところ
            ...
            - 2. 対話場面:人　vs エージェントの対話
                ...
                - 案1の困っているところ
                    ...
                    - 学校で女子大学生被験者募集するなら、被験者募集と、実体を持つエージェントと対話実験を行う必要があり、crowd workersより時間とコストがかかる。また、被験者数もcrowd workersより少なく、励まし効果評価結果の一般性と普遍性が少し足りない。
...
- 尺度：SWBの中の**ポジティブ感情**を評価する尺度
    - 例：WHO-5、PANAS...
- 今の困っているところ（現段階でこの内容を話すのが少し早いかも）
    - 被験者募集の問題（2週間毎日対面対話実験の実施が必要、2週間のある日来れないなら被験者データが使えない可能性がある）

### TODO4:励まし効果とrelastionshipの分析
- 分析の理由
    - 長期的な対エージェント対話実験を実施するときに、人間とエージェントの間にさらに「関係」が生じる可能性がある
    例えば、そもそも友人関係の二人が、毎日対話して一定の期間後、この二人の関係が対話開始前もっと親しくなったり、相手の励まし言葉（特に肯定安心させる、関心を示す励まし）がより信じやすいなどの可能性があると思います。つまり同じ対象であっても時間を経って励まし効果が上がる可能性があると思います。（もちろん上がらない・下がるなどの可能性もある）人間とエージェントの間にもこの可能性があるかもしれません。
- 
- 目的：（励ましをする）対話エージェントと（励ましを受ける）被験者の間のrelastionshipが
長期的な対エージェント対話実験を実施するときに、人間とエージェントの間にさらに「関係」が生じる可能性があると思います。
HumanとAgentのrelastionshipはHAI研究で考慮しなきゃいけない点
- 大体のイメージ
