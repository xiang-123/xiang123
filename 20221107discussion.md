...
## 2.研究背景
### 背景のロジック
女子大学生は様々な種類の悩みを抱えている
    ↓
悩みを抱えている人間は友人からの情緒的サポートを期待する
    ↓
励ましは情緒的サポートの一つ

主観的幸福感（SWB）は3つの要素から構成される
（1）生活満足度(個人が自分の生活をどのように評価しているかに関する指標）
（2）ポジティブ感情(喜び、楽しさといった感情を経験する)
（3）ネガティブ感情である(怒り、悲しみといった感情を経験する)
    ↓
励まし(encouragement)経験の有無は主観的幸福感(生活満足度+ポジティブ感情+ネガティブ感情)の高さと関連する
    ↓
励まされたと感じる経験の積み重ねにより⻑期的な主観的幸福感の向上を達成する

①励まされたと感じる経験の積み重ねによって、ポジティブな感情が向上できる
　　　　　↓そして
②ポジティブな感情が主観的幸福感の構成要素
　　　　　↓なので
ポジティブな感情の向上により、主観的幸福感が向上できると考えられる
　　　　　↓（また？ただし？）
③励まし発話の種類が異なると、励まされたと感じる程度が異なる
　　　　　↓なので　　
一番励まされたと感じる励まし発話の種類はなんなのかを探求する

励ましの経験が「励ました経験」なのか「励まされた経験」なのかわからなくなるところがあります。さらに、一時的なSWBと長期的なSWBがなんなのか説明する必要があると思います。
    ...
    1. いくつかの種類の悩み発話データを収集する
        ...
        - 今の困っているところ
            ...
            - 案：1種類の悩み発話の典型例を３〜５件収集
                ...
                - **ただし、対話システム構築するときに、さらに大量の発話データペアが必要**
...
### 2023HAIシンポジウム(ポスター発表)(申込締切01/21 18:00)
- 発表内容
    - (1)全体の研究計画
    - (2)種類の対応関係の調査結果
    - (3)構築した対話システム
