...
|ポイント|先行研究|自分の研究|
|:---|:---:|:---:|
|目的|ロボットと対話することによって、mental health，emotional well-beingという心理的健康（ポジティブ感情の向上、孤独感の軽減、ストレスレベルの低減）を促進する|励まし発話を提供する対話ロボットによって主観的幸福感を向上させる|
|対話エージェント実体の有無|実体あり|実体あり|
|言語/非言語|言語|言語|
|音声/テキスト|音声|音声|
...
|着目点|①長期的なSocial Robotsとの対話を通じて、被験者の自己開示の変化、ロボットに対する認識、心理的健康に与える影響を調査。②ロボットによるCOVID-19関連のテーマと一般的なテーマが、それらの効果の比較|対話ロボットの励ましという言語行為がユーザに与える影響、ロボットと人間の比較|
