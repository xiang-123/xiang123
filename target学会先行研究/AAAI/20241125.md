...
### 背景
- 人々の心理的健康を支援するための長期的なSocial Robotsの役割に関する理解は限られている。
...
### 具体的な対話内容
- 対話の流れ
    - 挨拶と簡単な自己紹介（ロボットが参加者の名前や近況を聞く）
    - テーマに関する質問：ロボットがあらかじめランダムに選ばれたテーマについて3つの質問を提示
        - How was your weekend? Did you do anything interesting?
        - 
    - When questions were repeated, participants were encouraged to answer from a new perspective and share more details
    - セッションの最後、ロボットが参加者の回答に対して励ましのコメントや感謝を表明し終了(At the end of each session, Pepper concluded the interaction by delivering an encouraging comment or expressing gratitude for the participant’s responses, thereby concluding the interaction on a positive note)
    - “Thank you for sharing with me,” “Thank you for telling me,” “What a nice memory. Thank you for sharing with me.”
- 対話のテーマ：日常生活やCOVID-19関連の話題
...
- 質問の提示順と形式：各セッションで提示される3つの質問はランダムに選ばれ、繰り返し提示する中で参加者に詳細な回答を促す工夫がされている
...
### 結果
- **心理的健康の変化**
    - Pepperとの対話後、参加者の気分が顕著に改善（IMS-12のスコアが上昇した）
...
|音声対話実験実施の有無|あり（対照実験、オンライン）|あり（対照実験、対面）|
|対照実験|日常生活の話題を提示するロボット　vs. COVID-19関連の話題を提示するロボット|対人間 vs. 対ロボット|
|対象||高齢者16名程度|
|wellbeingとは||subjective well-being(SWB)|
|wellbeingを高める方法|自己開示を促進する対話を提供|効果的な励まし発話を提供|
|インタラクションの期間と毎回インタラクションの長さ|長期（5週間)、週2回（毎回30分程度）|長期（8週間予定）、週1回程度（毎回20分程度）|
|評価（主観評価/客観評価）|音声対話を通じてWBが上がったか主観評価|音声対話を通じてSWBが上がったかに対する主観評価|
|評価対象|対話する**前後**、WBの**変化**|対話ロボットから提供された励ましを聞いた**前後**、SWBの**変化**|
|着目点|長期的なSocial Robotsとの対話を通じて、被験者の自己開示の変化、ロボットに対する認識、心理的健康に与える影響を調査する
- COVID-19関連のテーマと一般的なテーマが、自己開示、ロボットへの認識、心理的健康に与える影響の効果の比較|対話ロボットの励ましという言語行為がユーザに与える影響、ロボットと人間の比較|
