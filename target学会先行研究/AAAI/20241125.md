...
- 自己開示（Self-Disclosure）は関係構築（building relationships）、感情的な健康を支援する（supporting emotional well-being）上で重要なコミュニケーション行動である。しかし、自然な環境でその効果を研究する実験は少ない(remain relatively rare)
