...
### 背景
- 人们对社交机器人（Social Robots）在支持心理健康领域的长期作用了解有限。现有研究多集中于单次或短期实验，而忽视了社交机器人能否通过长期互动促进情绪健康和自我揭露（Self-Disclosure）的可行性。自我揭露是一种重要的沟通行为，对建立关系和心理健康有积极影响。然而，在长期自然情境中研究这种作用的实验设计仍然缺乏。
- 人々の心理的健康を支援するための長期的な社会的ロボット（Social Robots）の役割に関する理解は限られている。これまでの研究は単発または短期的な実験に集中しており、社会的ロボットが長期的な対話を通じて感情の健康や自己開示（Self-Disclosure）を促進する可能性については十分に探求されていない。自己開示は関係構築や心理的健康において重要なコミュニケーション行動であるが、自然な環境でその効果を研究する実験は依然として不足している。

### 目的
- 長期的な社会的ロボットとの対話が参加者の自己開示行動、ロボットに対する認識、および心理的健康関連の要因にどのように影響するかを調査すること。
- 対話のフレーム（例：COVID-19関連または一般的なテーマ）が、参加者の自己開示、ロボットに対する認識、心理的健康にどのように影響を与えるかを探求すること。

- our aim here was to examine how long-term repeated interactions with a social robot affect people’s self-disclosure behaviour toward the robot, their perceptions of the robot, and how such sustained interactions influence factors related to well-being.
-  evaluate people’s self-disclosure during interactions with a social robot over time. More specifi- cally, we explored how prolonged and intensive interac- tions with a social robot affect people’s self-disclosure behaviour toward the robot, perceptions of the robot, and additional factors related to well-being. Therefore, we were asking—
-  RQ1: To what extent are people’ s self-disclosures, percep- tions of the robot, and well-being affected over time during long-term interactions with a social robot?
...
- 募集方法：Prolificを通じて募集し、安定したインターネット環境、コンピュータ、およびビデオ会議の条件を備えた参加者を対象とした。

### 実験デザインの詳細
- 被験者間対照実験
    - 2グループ間デザイン（COVID-19関連テーマと一般テーマ）×10回の対話。
    - 参加者はロボットPepperとZoomを介して対話を行い、週2回、5週間にわたって実施。
    - 各対話では、Pepperが3つの質問を繰り返し3回提示。
- 対話内容：
    - 一般グループ：日常生活の話題（健康、社交、目標など）。
    - COVID-19グループ：日常の話題をCOVID-19の文脈で展開（例：パンデミック中の社交状況）。
- タスクの流れ：
    - 挨拶、自己紹介、テーマに関する質問、終了の挨拶が含まれる。
    - Pepperは事前設定されたスクリプトを使用し、Wizard-of-Oz技術で自律応答を模倣。

### 具体的な対話内容
- 対話のテーマは日常生活やCOVID-19関連の話題に基づき、以下のような内容が含まれる：
- 「最近の1週間はどうでしたか？」
- 「あなたの生活目標は何ですか？」

### 使ったアンケート
- 心理的健康の評価：
    - Immediate Mood Scaler (IMS-12)：気分の変化を測定
...
- 自己開示の評価
    ...
    - 発話時間と語数分析：客観的な開示度
- ロボットに対する認識
    - Friendliness and Warmth：親しみやすさの評価
    - Communication Competency：コミュニケーション能力の評価

### 結果
- **心理的健康の変化**
    - Pepperとの対話後、参加者の気分が顕著に改善（IMS-12のスコアが上昇）
    - 長期的な対話を通じて孤独感が有意に減少
- **自己開示の変化**
    - 参加者は徐々により多くの個人情報を開示する傾向（発話時間・語数の増加）
    - 対話フレームは自己開示行動に顕著な影響を与えなかった
- **ロボットに対する認識の変化**
    - 参加者はPepperをより社会的で有能だと感じるようになった
    - Pepperの応答がより慰めになると感じるようになった
...
|wellbeingを高める方法|自己開示を促進する対話を提供|効果的な励まし発話を提供|
...
关于在HRI中【long-term】的定义我还是不太明确，5周就可以说是long-term了吗
但是目前为止，做短期interaction的还是多，做2个月及以上与实体robot的interaction实验的研究还是不多
...
【人机交互(HRI)研究面临的挑战之一是如何利用和评估长期交互，尤其是在人的自然 环境中。】这一点，long-term的问题点已经被人发现了，但是实际上的实证研究还是很少，能做长期的interaction的，实际的对面的interaction实验还是很有限。

研究人机交互的时候，在interaction的部分，心理学和人类学和社会学的背景的文献也很需要，

因为我目前还是只专注于HRI的学会/杂志，发现了HAI，HRI，ROMAN，ICSR，AAAI，International Conference on Afective Computing and Intelligent Interaction Workshops and Demos (ACIIW)，JMIR Ment Health，International Journal of Social Robotics，最多的是HRI学会和International Journal of Social Robotics杂志。我觉得可以开始找老年学相关的学会/杂志，
