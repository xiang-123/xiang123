...
# 3年間のスケジュール更新（2024/10/04更新）
<img width="620" alt="スクリーンショット 2024-10-02 0 14 32" src="https://github.com/user-attachments/assets/e2bd56a1-a914-4ff4-a3d2-faefe8460259">


# 2024/10～2025/03の計画
## スケジュール（2024/10/02）
### D1後半（2024/10~2025/03）
- 優先度1:励まし効果評価実験（実験1）の準備＋実施
- 優先度2:実験2用の対話ロボットの仮構築
  - 理由：励まし効果評価実験の結果に基づいて作った対話ロボットと一時的に対話できるかを調査
  - 達成：数人の大学生と無事に対話できたらOK
- 優先度3:



- 優先度1:実験2用の対話ロボットの仮構築（理由：励まし効果評価実験の結果に基づいて作った対話ロボットと一時的に対話できるかを調査。達成：数人の大学生と無事に対話できたらOK）
...
|Num|タスク|優先度||10月|11月|12月|1月|2月|3月|メモ|
|---|---|---|:---:|:---:|:---:|:---:|:---:|:---:|---|
...
* 実験2：2024/12/03（予備実験）、2024/02/04 or 2025/03/20頃?（改良後の本実験）
  - 11月～1月実験2の予備的な調査：高齢者とロボットの対話のみ（倫理審査がない。目的：実験2の試し。悩みの種類に関わらず、5種類の励ましからランダムに1つ生成。倫理審査がないからアンケート調査はしない）
...
|（プログラムはまだ）2025/03/20-22|[人工知能学会 言語・音声理解と対話処理研究会（SLUD）第103回研究会](https://ai-gakkai.or.jp/sig-slud/)|発表申込締切：2025/02/01頃|原稿締切：2025/02/20頃 <br> 初稿共有：2025/02/10頃|- 案1:11月~1月中実験2の予備的な調査の結果?(アンケートはないからたぶんできない) <br> - → 案2:実験1の結果をもとに作った対話モデル＋高齢者数人の1-2回の対話後の結果(1月末～3月実験2の予備実験)|
